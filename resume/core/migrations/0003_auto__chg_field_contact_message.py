...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_contact', 'message', self.gf('django.db.models.fields.TextField')(max_length=4000))

    def backwards(self, orm):

        # Changing field 'Contact.message'
        db.alter_column(u'core_contact', 'message', self.gf('django.db.models.fields.TextField')(max_length=500))
